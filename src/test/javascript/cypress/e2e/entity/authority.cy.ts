...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '41cda40b-fc96-4704-8ff7-cde1d7500d76' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('af6e71eb-2fae-483c-9ea2-4e33d857d4ad');
      cy.get(`[data-cy="name"]`).should('have.value', 'af6e71eb-2fae-483c-9ea2-4e33d857d4ad');
